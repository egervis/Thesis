...
public class NearbyConnectionsManagerCluster {
    ...
    //teacher
    public NearbyConnectionsManagerCluster(Context context, String nickname, String password, String serviceId, ArrayList<String> userIds, HashMap<String, User> map, TextView teacherText) {
        this.isTeacher = true;
        this.connected = false;
        this.context = context;
        this.nickname = nickname;
