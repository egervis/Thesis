...
public class QuizSessionStudentListAdapter extends RecyclerView.Adapter<QuizSessionStudentListAdapter.QuizSessionHolder> {
    private ArrayList<QuizSessionStudent> quizSessions;
    private Context context;
    private String userId;

    public QuizSessionStudentListAdapter(ArrayList<QuizSessionStudent> quizSessions, Context context, String userId) {
    ...
    public QuizSessionHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.holder_quiz_session_student, parent, false);
