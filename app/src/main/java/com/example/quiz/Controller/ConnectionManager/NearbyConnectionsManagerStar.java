...
public class NearbyConnectionsManagerStar {
    ...
    //student
    public NearbyConnectionsManagerStar(Context context, String nickname, String serviceId, Callable<Void> callback) {
        isTeacher = false;
    ...
    //teacher
    public NearbyConnectionsManagerStar(Context context, String nickname, String password, String serviceId, ArrayList<String> userIds, HashMap<String, User> map, TextView teacherText) {
        isTeacher = true;
        this.context = context;
        this.nickname = nickname;
                ...
                switch (result.getStatus().getStatusCode()) {
                    case ConnectionsStatusCodes.STATUS_OK:
                        ...
                        if(isTeacher) {
                            ...
                            teacherText.setText("Authenticated " + map.get(endpointNickname).getFirstName() + " " + map.get(endpointNickname).getLastName());
